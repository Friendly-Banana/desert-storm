...
public class DesertStorm implements ModInitializer {
    public static final ItemGroup ITEM_TAB = FabricItemGroupBuilder.create(Utils.NewIdentifier("item_tab"))
    ...
    public static final BatteryItem BATTERY_ITEM = registerCustomItem(
            new BatteryItem(new FabricItemSettings().group(ITEM_TAB)));
    ...
    public static final BlockItem NETHER_PORTAL_ITEM = registerItem("nether_portal",
            new BlockItem(Blocks.NETHER_PORTAL, new FabricItemSettings().group(ITEM_TAB)));
    public static final BlockItem END_PORTAL_ITEM = registerItem("end_portal",
            new BlockItem(Blocks.END_PORTAL, new FabricItemSettings().group(ITEM_TAB)));
    public static final BlockItem END_GATEWAY_ITEM = registerItem("end_gateway",
            new BlockItem(Blocks.END_GATEWAY, new FabricItemSettings().group(ITEM_TAB)));
    // Blocks
