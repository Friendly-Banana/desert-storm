...
public class DesertStorm implements ModInitializer {
	...
	static {
		...
		MONKEY = Registry.register(Registry.ENTITY_TYPE, Utils.NewIdentifier("monkey"), FabricEntityTypeBuilder
				.create(SpawnGroup.CREATURE, Monkey::new).dimensions(EntityDimensions.fixed(0.75f, 0.75f)).build());

		// #FFE900, #000000 in decomal
		SAND_WITHER_SPAWN_EGG = new SpawnEggItem(SAND_WITHER, 16771328, 0,
				new FabricItemSettings().group(ItemGroup.MISC));
		MONKEY_SPAWN_EGG = new SpawnEggItem(MONKEY, 10107904, 0, new FabricItemSettings().group(ItemGroup.MISC));
		...
		// fcking Java: can't infer Type T, needs extra MONKEYline
