...
public class DesertStorm implements ModInitializer {
	...
	public static final SpawnEggItem SANDWORM_SPAWN_EGG = registerItem("sandworm_spawn_egg", new SpawnEggItem(DSEntities.ROLLING_BARREL, 0xEDEBCB, 0, new FabricItemSettings()));
