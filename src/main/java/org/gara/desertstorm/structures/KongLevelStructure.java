...
public class KongLevelStructure extends StructureFeature<DefaultFeatureConfig> {
    /**
    ...
    public KongLevelStructure(Codec<DefaultFeatureConfig> codec) {
        super(codec);
    }

    @Override
    public StructureStartFactory<DefaultFeatureConfig> getStructureStartFactory() {
        return KongLevelStructure.Start::new;
    }
    ...
    public static class Start extends MarginedStructureStart<DefaultFeatureConfig> {
        ...
        public void init(DynamicRegistryManager dynamicRegistryManager, ChunkGenerator chunkGenerator, StructureManager structureManager, ChunkPos chunkPos, Biome biome, DefaultFeatureConfig defaultFeatureConfig, HeightLimitView heightLimitView) {
            ...
            StructurePoolFeatureConfig structureSettingsAndStartPool = new StructurePoolFeatureConfig(() -> dynamicRegistryManager.get(Registry.STRUCTURE_POOL_KEY)
                    ...
                    .get(Utils.NewIdentifier("kong_level/start_pool")),
            ...
            Utils.Log("Kong Level at ", this.children.get(0).getBoundingBox().getMinX(),
                    this.children.get(0).getBoundingBox().getMinY(), this.children.get(0).getBoundingBox().getMinZ());
        }
